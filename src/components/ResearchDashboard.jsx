...
const fetchResearchData = async () => {
  ...
  return [
    ...
    { id: 7, title: "Quantum Game Development Wiki", type: "Wiki", url: "/wiki/quantum-game-dev" },
    { id: 8, title: "Quantum Physics SDK", type: "SDK", url: "/sdk/quantum-physics" },
    { id: 9, title: "Game Modding Tutorial", type: "Tutorial", url: "/tutorials/game-modding" },
    { id: 10, title: "Quantum Algorithms Research", type: "Article", url: "/quantum-algorithms-research" },
  ];
};
