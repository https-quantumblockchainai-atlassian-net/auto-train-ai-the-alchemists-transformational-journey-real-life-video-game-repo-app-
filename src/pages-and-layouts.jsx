...
import QuantumBasics from "./pages/quantum/QuantumBasics";
import AdvancedRealms from "./pages/quantum/AdvancedRealms";
import QuantumDebugger from "./pages/tools/QuantumDebugger";
import RealmInspector from "./pages/tools/RealmInspector";
...
const routes = [
  {
    ...
    children: [
      ...
      { path: "tutorials/quantum-basics", element: <QuantumBasics /> },
      { path: "tutorials/advanced-realms", element: <AdvancedRealms /> },
      { path: "tools/quantum-debugger", element: <QuantumDebugger /> },
      { path: "tools/realm-inspector", element: <RealmInspector /> },
    ],
  },
];
