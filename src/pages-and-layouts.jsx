...
import QuantumAIBehaviors from "./pages/features/QuantumAIBehaviors";
import QuantumCryptography from "./pages/features/QuantumCryptography";
import QuantumMLGameDesign from "./pages/features/QuantumMLGameDesign";
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/features/quantum-ai-behaviors", element: <QuantumAIBehaviors /> },
      { path: "/features/quantum-cryptography", element: <QuantumCryptography /> },
      { path: "/features/quantum-ml-game-design", element: <QuantumMLGameDesign /> },
    ],
  },
]);